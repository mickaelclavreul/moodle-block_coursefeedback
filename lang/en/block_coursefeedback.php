...
$string['adminpage_html_defaultscaleb'] = 'Available scales are "Classic" (default) with emoticons and text, "Numeric" to display values (from 1 to 9) only, and "User defined" to propose your own textual scale';
$string['adminpage_html_scalenumbera'] = 'Number of values';
$string['adminpage_html_scalenumberb'] = 'Number of values from 1 to 9 to display';
