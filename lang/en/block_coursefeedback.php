...
$string['adminpage_html_headingdefault_hiddena'] = 'Default visibility in courses';
$string['adminpage_html_headingdefault_hiddenb'] = 'Default visibility, if enabled, will hide block in all courses. Default visibility is available if the block is active through "global_enable" setting.';
$string['adminpage_html_default_hiddena'] = 'Hide blocks in all courses'; 
$string['adminpage_html_default_hiddenb'] = 'If enabled, the block will appear hidden in all courses unless a teacher makes it visible explicitly.'; 
...
$string['adminpage_html_headingscale'] = 'Scale configuration';
...
$string['adminpage_html_defaultscalea'] = 'Choose scale';
$string['adminpage_html_defaultscaleb'] = 'Available scales are "Classic" (default) with emoticons and text, "Numeric" to display values (from 1 to N) only, and "User defined" to propose your own textual scale';
$string['adminpage_html_scalenumbera'] = 'Number of values';
$string['adminpage_html_scalenumberb'] = 'Number of values to display from 1 to N';
$string['adminpage_html_scaletextsa'] = 'Scale entries';
$string['adminpage_html_scaletextsb'] = 'A list of CSV values to display';
...
$string['numusers'] = 'Number of users in course';
