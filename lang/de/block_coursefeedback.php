...
$string['adminpage_html_headingdefault_hiddena'] = 'Standardsichtbarkeit in Kursen';
$string['adminpage_html_headingdefault_hiddenb'] = 'Wenn die Standardsichtbarkeit aktiviert ist, wird der Block in allen Kursen ausgeblendet. Die Standardsichtbarkeit ist verfügbar, wenn der Block über die Einstellung "global_enable" aktiv ist.';
$string['adminpage_html_default_hiddena'] = 'Blöcke in allen Kursen ausblenden'; 
$string['adminpage_html_default_hiddenb'] = 'Wenn aktiviert, der Block wird in allen Kursen ausgeblendet angezeigt, es sei denn, ein Lehrer macht ihn explizit sichtbar.'; 
...
$string['adminpage_html_headingscale'] = 'Skalenkonfiguration';
$string['adminpage_html_headingscale1'] = 'Classic';
$string['adminpage_html_headingscale2'] = 'Numeric';
$string['adminpage_html_headingscale3'] = 'User defined';
$string['adminpage_html_defaultscalea'] = 'W&auml;hlen Sie den Skala';
$string['adminpage_html_defaultscaleb'] = 'Verfügbare Skalen sind "Classic" (Standard) mit Emoticons und Text, "Numeric" zur Anzeige von Werten (von 1 bis 9), und "User defined", um eine eigene Textskala vorzuschlagen.';
$string['adminpage_html_scalenumbera'] = 'Anzahl der Werte';
$string['adminpage_html_scalenumberb'] = 'Anzahl der anzuzeigenden Werte von 1 bis 9';
$string['adminpage_html_scaletextsa'] = 'Skaleneinträge';
$string['adminpage_html_scaletextsb'] = 'Eine Liste der anzuzeigenden CSV-Werte';
